          ...
          <div className="flex-1 w-full max-w-lg lg:max-w-xl relative">
            ...
            >
              ...
              <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
                <img src="images/image-business-hero/main.jpg" alt="Training" className="w-full h-auto object-cover transform hover:scale-105 transition-transform duration-700" />
              </div>
            </motion.div>
            ...
            >
              <img src="images/image-business-hero/296d3bc1ddca55940cdb.jpg" alt="Team" className="w-full h-auto" />
            </motion.div>
            ...
            >
              <img src="images/image-business-hero/0e7ddefb38f0b0aee9e1.jpg" alt="Meeting" className="w-full h-auto" />
            </motion.div>
