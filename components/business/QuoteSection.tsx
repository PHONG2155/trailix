      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 text-center">
        <Reveal>
          <div className="relative p-12 md:p-24 border-y-2 border-gray-50 bg-gradient-to-r from-transparent via-gray-50/50 to-transparent">
             ...
             <h3 className="text-3xl md:text-5xl font-semibold text-gray-800 italic leading-snug font-display">
               "AI sẽ không thay thế con người. Nhưng những người biết sử dụng AI sẽ thay thế những người không biết."
             </h3>
