      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col justify-center items-center relative px-4">
           ...
           >
            ...
            <span className="text-sm font-bold text-red-700 tracking-wide uppercase">AI Data Analysis</span>
          </motion.div>
          ...
          <div className="max-w-screen-2xl mx-auto text-center space-y-6 px-4">
            ...
            >
              Biến <span className="text-slate-900 font-bold">Dữ Liệu Thô</span> Thành <span className="text-slate-900 font-bold">Chiến Lược</span> Kinh Doanh.
            </motion.p>
        ...
        <section className="py-24 bg-white relative">
            ...
            <h3 className="text-3xl md:text-4xl font-black leading-tight text-slate-900">
              “Dữ liệu là tài sản. <br />
              <span className="text-red-600">
                 AI là công cụ khai thác tài sản đó để tạo ra lợi nhuận.
              </span>”
            </h3>
          </motion.div>
        </section>
            ...
            >
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group overflow-hidden relative">
                <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:opacity-10 transition-opacity">
                    <Database className="w-40 h-40 text-red-600" />
                </div>
                <div className="relative z-10">
                    <div className="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mb-6">
                      <Database className="w-7 h-7" />
                    </div>
                    <h4 className="text-2xl font-bold mb-3 text-slate-900">Quy trình xử lý dữ liệu</h4>
                    <p className="text-slate-600 text-lg leading-relaxed max-w-md">
                      Làm chủ kỹ thuật làm sạch, chuẩn hóa và cấu trúc lại các file Excel/CSV phức tạp chỉ trong vài phút.
                    </p>
                </div>
              </motion.div>

              {/* Value 2: Analysis (Red Card) */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-red-700 text-white p-10 rounded-3xl shadow-xl shadow-red-900/10 flex flex-col justify-between group">
                <div>
                    ...
                    <h4 className="text-2xl font-bold mb-3">Phân tích chuyên sâu</h4>
                    <p className="text-red-50 text-lg">
                      Thống kê, tìm ra xu hướng (trend) ẩn giấu và trích xuất insights giá trị để ra quyết định.
                    </p>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group">
                ...
                <h4 className="text-xl font-bold mb-3 text-slate-900">Báo cáo ấn tượng</h4>
                <p className="text-slate-600 text-lg">
                  Kỹ thuật trực quan hóa (Visualization) và kể chuyện với dữ liệu (Data Storytelling) đầy thuyết phục.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all flex items-center gap-8">
                 ...
                 <div>
                    <h4 className="text-xl font-bold mb-2 text-slate-900">Không cần lập trình</h4>
                    <p className="text-slate-600 text-lg">
                      Phân tích dữ liệu nhanh chóng, chính xác mà không cần biết Python hay SQL, phù hợp với dân văn phòng.
                    </p>
                 </div>
              </motion.div>
            </motion.div>
        ...
        <section className="py-24 px-4 bg-white relative">
          <div className="max-w-5xl mx-auto">
             ...
             >
                 ...
                 <p className="text-slate-500 text-lg">Lộ trình làm chủ dữ liệu từ A-Z.</p>
             </motion.div>
             ...
             >
                {[
                    { step: "01", title: "Tổng quan về Dữ liệu", content: "Phân biệt dữ liệu có cấu trúc và phi cấu trúc, tư duy Data-driven." },
                    { step: "02", title: "Làm sạch dữ liệu", content: "Tự động phát hiện và xử lý dữ liệu lỗi, thiếu sót, chuẩn hóa định dạng." },
                    { step: "03", title: "Phân tích cơ bản", content: "Thống kê mô tả, nhận diện mẫu (pattern) và phát hiện các điểm bất thường." },
                    { step: "04", title: "Trích xuất Insights", content: "Tìm ý nghĩa đằng sau những con số khô khan và đưa ra khuyến nghị hành động." },
                    { step: "05", title: "Dự báo (Forecasting)", content: "Mô phỏng kịch bản (What-if analysis) và dự đoán xu hướng kinh doanh tương lai." },
                    { step: "06", title: "Trực quan hóa", content: "Lựa chọn biểu đồ hiệu quả, xây dựng Dashboard theo dõi chỉ số." },
                    { step: "07", title: "Kỹ năng báo cáo", content: "Tối ưu hóa slide báo cáo chiến lược và kỹ thuật kể chuyện với dữ liệu." }
                ].map((item, index) => (
                    <motion.div 
                      key={index} 
                      variants={fadeInUp}
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
             ...
             >
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {["Quản lý", "Chuyên viên phân tích", "Marketing Manager", "Chủ doanh nghiệp", "Kế toán/Tài chính"].map((tag, i) => (
                    <motion.span 
                      key={i} 
             ...
             >
                ...
                <p className="text-slate-500 mb-12 text-xl relative z-10 max-w-2xl mx-auto">
                    Biến những con số khô khan thành vũ khí chiến lược sắc bén cho doanh nghiệp của bạn.
                </p>
