     ...
     {/* ================= HERO SECTION (FULL SCREEN) ================= */}
        <section className="min-h-screen flex flex-col justify-center items-center relative px-4">
           ...
           >
            ...
            <span className="text-sm font-bold text-red-700 tracking-wide uppercase">AI Foundation Course</span>
          </motion.div>
          ...
          <div className="max-w-screen-2xl mx-auto text-center space-y-6 px-4">
            <motion.h1 
              ...
              viewport={{ once: true }}
              // ĐÃ SỬA: Size 4xl-7xl, dãn chữ rộng, dãn dòng chuẩn
            ...
            >
              PROMPT ENGINEERING
              {/* ĐÃ SỬA: Xóa SVG gạch chân, dùng block mt-2 để tách dòng */}
            ...
            >
              Viết Lệnh Hiệu Quả Lần Đầu – <span className="text-slate-900 font-bold">Bước Chân</span> Vào Thế Giới AI.
            </motion.p>
        ...
        <section className="py-24 relative">
            {/* Thêm background gradient nhẹ cho section này */}
            ...
            <h3 className="text-3xl md:text-4xl font-black leading-tight text-slate-900">
              “Một câu lệnh (prompt) tốt là chìa khóa mở cửa kho tàng tri thức của AI. <br />
              <span className="text-red-600">
                  Hãy bắt đầu từ những câu hỏi đúng.
              </span>”
            </h3>
          </motion.div>
        </section>
        ...
        {/* ================= CORE VALUES ================= */}
        <section className="py-24 px-4 bg-slate-50/80 backdrop-blur-sm relative"> {/* Thêm backdrop-blur */}
           {/* Thêm một blob mờ ở section này */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              {/* Value 1 */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white/80 backdrop-blur-md p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group overflow-hidden relative">
                <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:opacity-10 transition-opacity">
                    <Terminal className="w-40 h-40 text-red-600" />
                </div>
                <div className="relative z-10">
                    <div className="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mb-6 shadow-sm">
                      <Terminal className="w-7 h-7" />
                    </div>
                    <h4 className="text-2xl font-bold mb-3 text-slate-900">Cấu trúc Prompt chuẩn</h4>
                    <p className="text-slate-600 text-lg leading-relaxed max-w-md">
                      Hiểu rõ cấu trúc và các thành phần cốt lõi (Bối cảnh, Chỉ dẫn, Định dạng) của một câu lệnh mang lại hiệu quả cao nhất.
                    </p>
                </div>
              </motion.div>

              {/* Value 2 */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-gradient-to-br from-red-600 to-red-800 text-white p-10 rounded-3xl shadow-xl shadow-red-900/20 flex flex-col justify-between group relative overflow-hidden">
                {/* Thêm hiệu ứng noise nhẹ cho thẻ màu đỏ */}
                ...
                <div className="relative z-10">
                    ...
                    <h4 className="text-2xl font-bold mb-3">Ứng dụng ngay</h4>
                    <p className="text-red-100 text-lg">
                      Áp dụng ngay kỹ thuật prompt vào xử lý công việc hàng ngày: soạn mail, viết content, phân tích.
                    </p>
                </div>
              </motion.div>

              {/* Value 3 */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-white/80 backdrop-blur-md p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group">
                 <div className="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mb-6 shadow-sm">
                  <PenTool className="w-7 h-7" />
                </div>
                <h4 className="text-xl font-bold mb-3 text-slate-900">Kỹ năng viết sắc bén</h4>
                <p className="text-slate-600 text-lg">
                  Rèn luyện tư duy ngôn ngữ, viết prompt rõ ràng, cụ thể để AI hiểu và trả về kết quả chính xác.
                </p>
              </motion.div>

              {/* Value 4 (Combined Benefit) */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white/80 backdrop-blur-md p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all flex items-center gap-8">
                 ...
                 <div>
                    <h4 className="text-xl font-bold mb-2 text-slate-900">Làm chủ công cụ</h4>
                    <p className="text-slate-600 text-lg">
                      Tự tin điều khiển ChatGPT, Claude, Gemini để tự động hóa tác vụ và giải phóng sức lao động.
                    </p>
                 </div>
              </motion.div>
            </motion.div>
        ...
        <section className="py-24 px-4 bg-white/60 backdrop-blur-md relative">
          <div className="max-w-5xl mx-auto">
             ...
             >
                 ...
                 <p className="text-slate-500 text-lg">Hệ thống kiến thức từ cơ bản đến ứng dụng.</p>
             </motion.div>
             ...
             >
                {[
                    { step: "01", title: "Tổng quan Generative AI", content: "Hiểu bản chất, cách hoạt động và tầm quan trọng của prompt." },
                    { step: "02", title: "Cấu trúc Prompt hiệu quả", content: "4 yếu tố vàng: Bối cảnh, Chỉ dẫn, Định dạng đầu ra, Ví dụ." },
                    { step: "03", title: "Các loại Prompt phổ biến", content: "Câu hỏi, mệnh lệnh, few-shot (học qua ví dụ), role-playing (đóng vai)." },
                    { step: "04", title: "Kỹ thuật viết tối ưu", content: "Nguyên tắc rõ ràng, cụ thể và chính xác về ngôn từ giao tiếp với AI." },
                    { step: "05", title: "Thực hành thực tế", content: "Viết prompt cho email, nội dung marketing, và phân tích dữ liệu sơ bộ." },
                    { step: "06", title: "Xử lý lỗi & Tinh chỉnh", content: "Nhận diện lỗi prompt mơ hồ, thiếu bối cảnh và cách khắc phục." },
                    { step: "07", title: "Tài nguyên cá nhân", content: "Xây dựng thư viện prompt mẫu cho công việc riêng của bạn." }
                ].map((item, index) => (
                    <motion.div 
                      key={index} 
                      variants={fadeInUp}
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
             ...
             >
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {["Người mới bắt đầu", "Nhân viên văn phòng", "Quản lý", "Content Creator", "Bất kỳ ai muốn tăng năng suất"].map((tag, i) => (
                    <motion.span 
                      key={i} 
             ...
             >
                ...
                <p className="text-slate-500 mb-12 text-xl relative z-10 max-w-2xl mx-auto">
                    Đừng bỏ lỡ cơ hội làm chủ công cụ AI và nâng cao năng suất làm việc ngay hôm nay.
                </p>
