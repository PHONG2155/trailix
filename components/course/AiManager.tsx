...
import { 
  ArrowRight, 
  Users,        // Icon cho Đội ngũ/Nhân sự
  LineChart,    // Icon cho Hiệu suất/Dữ liệu
  ShieldCheck,  // Icon cho Đạo đức/Tin cậy
  Briefcase,    // Icon cho Quản lý/Dự án
  GanttChartSquare, // Icon cho Quy trình/Tiến độ
  Zap,
  Target,
  Flame,
  MousePointerClick
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col justify-center items-center relative px-4">
           ...
           >
            ...
            <span className="text-sm font-bold text-red-700 tracking-wide uppercase">AI For Management & Leadership</span>
          </motion.div>
          ...
          <div className="max-w-screen-2xl mx-auto text-center space-y-6 px-4">
            ...
            >
              Tối Ưu Hóa <span className="text-slate-900 font-bold">Nguồn Lực</span> Và <span className="text-slate-900 font-bold">Hiệu Suất Team</span> Bằng Công Nghệ.
            </motion.p>
        ...
        <section className="py-24 bg-white relative">
            ...
            <h3 className="text-3xl md:text-4xl font-black leading-tight text-slate-900">
              “Người quản lý giỏi không phải là người làm thay nhân viên, <br />
              <span className="text-red-600">
                 mà là người trang bị cho nhân viên công cụ tốt nhất.”
              </span>
            </h3>
          </motion.div>
        </section>
            ...
            >
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group overflow-hidden relative">
                <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:opacity-10 transition-opacity">
                    <LineChart className="w-40 h-40 text-red-600" />
                </div>
                <div className="relative z-10">
                    <div className="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mb-6">
                      <LineChart className="w-7 h-7" />
                    </div>
                    <h4 className="text-2xl font-bold mb-3 text-slate-900">Quản trị dựa trên dữ liệu</h4>
                    <p className="text-slate-600 text-lg leading-relaxed max-w-md">
                      Quản lý hiệu suất, dự án và nhân sự một cách minh bạch, công bằng dựa trên phân tích dữ liệu thực tế và AI.
                    </p>
                </div>
              </motion.div>

              {/* Value 2: Decision Making (Red Card) */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-red-700 text-white p-10 rounded-3xl shadow-xl shadow-red-900/10 flex flex-col justify-between group">
                <div>
                    ...
                    <h4 className="text-2xl font-bold mb-3">Ra quyết định chính xác</h4>
                    <p className="text-red-50 text-lg">
                      Giảm thiểu cảm tính nhờ khả năng phân tích rủi ro và dự báo xu hướng của trí tuệ nhân tạo.
                    </p>
                </div>
              </motion.div>

              {/* Value 3: Optimization */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group">
                ...
                <h4 className="text-xl font-bold mb-3 text-slate-900">Tối ưu quy trình Team</h4>
                <p className="text-slate-600 text-lg">
                  Chuẩn hóa và tự động hóa quy trình làm việc của cả đội ngũ nhờ các công cụ cộng tác AI thông minh.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all flex items-center gap-8">
                 ...
                 <div>
                    <h4 className="text-xl font-bold mb-2 text-slate-900">Giải phóng Lãnh đạo</h4>
                    <p className="text-slate-600 text-lg">
                      Giảm tải các công việc hành chính quản trị (Admin) để tập trung hoàn toàn vào chiến lược và con người.
                    </p>
                 </div>
              </motion.div>
            </motion.div>
        ...
        <section className="py-24 px-4 bg-white relative">
          <div className="max-w-5xl mx-auto">
             ...
             >
                 ...
                 <p className="text-slate-500 text-lg">Bộ công cụ quản trị hiện đại cho Leader 4.0.</p>
             </motion.div>
             ...
             >
                {[
                    { step: "01", title: "AI trong Quản trị", content: "Tổng quan các công cụ AI hỗ trợ ra quyết định chiến lược và giám sát vận hành." },
                    { step: "02", title: "Quản lý hiệu suất", content: "Hỗ trợ đánh giá nhân viên (Review) công bằng, lập kế hoạch phát triển (IDP) cá nhân hóa." },
                    { step: "03", title: "Quản lý dự án", content: "Dự báo tiến độ, nhận diện rủi ro sớm và đề xuất phương án khắc phục." },
                    { step: "04", title: "Phân tích đội ngũ", content: "Theo dõi năng suất thực tế, cân bằng khối lượng công việc (Workload) để tránh quá tải." },
                    { step: "05", title: "Hoạch định nguồn lực", content: "Dự báo nhu cầu nhân sự tương lai, ghép nối kỹ năng nhân viên với dự án phù hợp." },
                    { step: "06", title: "Đào tạo & Coaching", content: "Sử dụng AI để training nhân viên mới và đóng vai trò Mentor hỗ trợ chuyên môn." },
                    { step: "07", title: "Đạo đức sử dụng AI", content: "Xây dựng niềm tin, đảm bảo sự minh bạch và bảo mật dữ liệu trong nội bộ." }
                ].map((item, index) => (
                    <motion.div 
                      key={index} 
                      variants={fadeInUp}
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
             ...
             >
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {["Team Leader", "Project Manager (PM)", "Trưởng phòng", "Giám đốc bộ phận", "Chủ doanh nghiệp"].map((tag, i) => (
                    <motion.span 
                      key={i} 
             ...
             >
                ...
                <p className="text-slate-500 mb-12 text-xl relative z-10 max-w-2xl mx-auto">
                    Nâng tầm năng lực lãnh đạo và quản trị đội ngũ với sức mạnh của dữ liệu và AI.
                </p>
