...
// IMPORT COMPONENT NÚT DOWNLOAD (Đã sửa ở Bước 1)
       ...
       {/* ================= HERO SECTION (FULL SCREEN) ================= */}
        <section className="min-h-screen flex flex-col justify-center items-center relative px-4">
           ...
           >
            ...
            <span className="text-sm font-bold text-red-700 tracking-wide uppercase">AI Event Master</span>
          </motion.div>
          ...
          <div className="max-w-screen-2xl mx-auto text-center space-y-6 px-4">
            ...
            >
              Biến <span className="text-slate-900 font-bold">Brief</span> thành <span className="text-slate-900 font-bold">Visual 3D</span> siêu tốc.
              <br/> Vũ khí tối thượng cho Event Agency.
            </motion.p>
        ...
        <section className="py-24 bg-white relative">
            ...
            <h3 className="text-3xl md:text-4xl font-black leading-tight text-slate-900">
              “Sân khấu là nơi rực rỡ nhất. <br />
              <span className="text-red-600">
                 AI giúp bạn tỏa sáng trong mọi dự án.
              </span>”
            </h3>
          </motion.div>
        </section>
            ...
            >
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group overflow-hidden relative">
                <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:opacity-10 transition-opacity">
                    <Layers className="w-40 h-40 text-red-600" />
                </div>
                <div className="relative z-10">
                    <div className="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mb-6">
                      <Layers className="w-7 h-7" />
                    </div>
                    <h4 className="text-2xl font-bold mb-3 text-slate-900">Quy trình "Zero to Hero"</h4>
                    <p className="text-slate-600 text-lg leading-relaxed max-w-md">
                      Làm chủ luồng công việc toàn diện: Phân tích Brief khó nhằn → Lên Concept độc đáo → Xuất Visual 3D chinh phục khách hàng.
                    </p>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-red-700 text-white p-10 rounded-3xl shadow-xl shadow-red-900/10 flex flex-col justify-between group">
                <div>
                    ...
                    <h4 className="text-2xl font-bold mb-3">Tốc độ tối đa</h4>
                    <p className="text-red-50 text-lg">
                      Dùng AI tạo Moodboard, Key Visual và phác thảo layout sân khấu nhanh gấp 10 lần cách làm cũ.
                    </p>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group">
                ...
                <h4 className="text-xl font-bold mb-3 text-slate-900">Video Diễn họa</h4>
                <p className="text-slate-600 text-lg">
                  Tạo video demo 3D với hiệu ứng ánh sáng, khói, cam movement cinematic.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all flex items-center gap-8">
                 ...
                 <div>
                    <h4 className="text-xl font-bold mb-2 text-slate-900">Tăng tỷ lệ Win Rate</h4>
                    <p className="text-slate-600 text-lg">
                      Thuyết phục chủ đầu tư nhờ những bản Proposal trực quan, sống động và đầy cảm xúc.
                    </p>
                 </div>
              </motion.div>
            </motion.div>
        ...
        <section className="py-24 px-4 bg-white relative">
          <div className="max-w-5xl mx-auto">
             ...
             >
                 ...
                 <p className="text-slate-500 text-lg">Hệ thống kiến thức từ cơ bản đến chuyên sâu.</p>
             </motion.div>
             ...
             >
                {[
                    { step: "01", title: "Phân tích Brief", content: "Hiểu nhu cầu khách hàng, mục tiêu và bộ nhận diện thương hiệu." },
                    { step: "02", title: "Brainstorm & Ý tưởng", content: "Phát triển Concept chủ đạo, Moodboard." },
                    { step: "03", title: "Key Visual", content: "Tạo hình ảnh chủ đạo bằng AI, tìm kiếm phong cách." },
                    { step: "04", title: "Phác thảo (Sketch)", content: "Bố cục không gian, sắp đặt sân khấu." },
                    { step: "05", title: "Dựng 3D Sân khấu & Booth", content: "Mô hình hóa cơ bản, chi tiết layout." },
                    { step: "06", title: "Ánh sáng & Góc quay", content: "Thiết kế ánh sáng sân khấu, chọn góc camera đắt giá." },
                    { step: "07", title: "Video diễn họa & Proposal", content: "Render video 3D, lồng ghép vào bài thuyết trình." }
                ].map((item, index) => (
                    <motion.div 
                      key={index} 
                      variants={fadeInUp}
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
             ...
             >
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {["Event Designer", "Art Director", "Account Manager", "Producer", "Freelancer"].map((tag, i) => (
                    <motion.span 
                      key={i} 
             ...
             >
                ...
                <p className="text-slate-500 mb-12 text-xl relative z-10 max-w-2xl mx-auto">
                    Đừng bỏ lỡ cơ hội làm chủ công nghệ AI trong thiết kế sự kiện.
                </p>

                <div className="relative z-10 flex flex-col md:flex-row gap-5 justify-center items-center">
                    
                    {/* NÚT 1: ĐIỀN FORM - KÍCH THƯỚC: h-16 w-[280px] */}
                    <motion.button
                    ...
                    {/* NÚT 2: TẢI ROADMAP (Component riêng, đã đồng bộ kích thước trong file kia) */}
