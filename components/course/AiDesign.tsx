...
import { 
  ArrowRight, 
  Palette,      // Icon cho Màu sắc/Design
  Image as ImageIcon, // Icon cho Hình ảnh
  Layout,       // Icon cho Bố cục/UI
  PenTool,      // Icon cho Thiết kế
  Monitor,      // Icon cho Web/Digital
  Zap,
  Target,
  Flame,
  MousePointerClick
       ...
       {/* ================= HERO SECTION (FULL SCREEN) ================= */}
        <section className="min-h-screen flex flex-col justify-center items-center relative px-4">
           ...
           >
            ...
            <span className="text-sm font-bold text-red-700 tracking-wide uppercase">AI For Creative Design</span>
          </motion.div>
          ...
          <div className="max-w-screen-2xl mx-auto text-center space-y-6 px-4">
            ...
            >
              Banner, Poster, Brochure, HTML Email – <span className="text-slate-900 font-bold">Giải Pháp Thiết Kế</span> Toàn Diện.
            </motion.p>
        ...
        <section className="py-24 bg-white relative">
            ...
            <h3 className="text-3xl md:text-4xl font-black leading-tight text-slate-900">
              “Bạn không cần là họa sĩ. Công thức: <br />
              <span className="text-red-600">
                 AI + Prompt + Tư duy thiết kế = Tác phẩm chuyên nghiệp.
              </span>”
            </h3>
          </motion.div>
        </section>
            ...
            >
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group overflow-hidden relative">
                <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:opacity-10 transition-opacity">
                    <Palette className="w-40 h-40 text-red-600" />
                </div>
                <div className="relative z-10">
                    <div className="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mb-6">
                      <Layout className="w-7 h-7" />
                    </div>
                    <h4 className="text-2xl font-bold mb-3 text-slate-900">Tư duy thiết kế (Design Thinking)</h4>
                    <p className="text-slate-600 text-lg leading-relaxed max-w-md">
                      Nắm vững các nguyên lý cốt lõi: Bố cục (Layout), lý thuyết màu sắc, Typography và phân cấp thông tin.
                    </p>
                </div>
              </motion.div>

              {/* Value 2: AI Tools (Red Card) */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-red-700 text-white p-10 rounded-3xl shadow-xl shadow-red-900/10 flex flex-col justify-between group">
                <div>
                    ...
                    <h4 className="text-2xl font-bold mb-3">Làm chủ công cụ AI</h4>
                    <p className="text-red-50 text-lg">
                      Sử dụng thành thạo Midjourney, Ideogram... để tạo ra những hình ảnh chất lượng cao, độc bản.
                    </p>
                </div>
              </motion.div>

              {/* Value 3: Practical Output */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group">
                ...
                <h4 className="text-xl font-bold mb-3 text-slate-900">Ấn phẩm thực tế</h4>
                <p className="text-slate-600 text-lg">
                  Tự tay thiết kế Banner, Brochure, Poster và Landing Page chuyên nghiệp ngay trong khóa học.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all flex items-center gap-8">
                 ...
                 <div>
                    <h4 className="text-xl font-bold mb-2 text-slate-900">Tự chủ & Nhất quán</h4>
                    <p className="text-slate-600 text-lg">
                      Giảm phụ thuộc vào thuê ngoài, tiết kiệm chi phí và đảm bảo tính nhất quán thương hiệu (Brand Consistency).
                    </p>
                 </div>
              </motion.div>
            </motion.div>
        ...
        <section className="py-24 px-4 bg-white relative">
          <div className="max-w-5xl mx-auto">
             ...
             >
                 ...
                 <p className="text-slate-500 text-lg">Từ tư duy thẩm mỹ đến kỹ năng thực thi sắc bén.</p>
             </motion.div>
             ...
             >
                {[
                    { step: "01", title: "Nền tảng Design Thinking", content: "Hiểu sâu về bố cục, màu sắc, font chữ và các nguyên tắc thị giác." },
                    { step: "02", title: "Phong cách thiết kế", content: "Khám phá các style: Hiện đại, Tối giản, Cổ điển, Corporate..." },
                    { step: "03", title: "Công cụ tạo ảnh AI", content: "Kỹ thuật và mẹo hay với Midjourney, Ideogram để tạo ảnh như ý." },
                    { step: "04", title: "Viết Prompt cho hình ảnh", content: "Công thức mô tả chi tiết, từ khóa phong cách và thông số kỹ thuật." },
                    { step: "05", title: "Thực hành ứng dụng", content: "Thiết kế Banner, Standee, Flyer, Social Post cho chiến dịch." },
                    { step: "06", title: "Thiết kế Web & Email", content: "Tạo Template HTML, cấu trúc Landing Page và Slide Background." },
                    { step: "07", title: "Hậu kỳ & Branding", content: "Chỉnh sửa, tăng độ phân giải (upscale) và kiểm soát nhận diện thương hiệu." }
                ].map((item, index) => (
                    <motion.div 
                      key={index} 
                      variants={fadeInUp}
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
             ...
             >
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {["Marketer", "Content Creator", "Chủ doanh nghiệp nhỏ", "Freelancer", "Nhân viên văn phòng"].map((tag, i) => (
                    <motion.span 
                      key={i} 
             ...
             >
                ...
                <p className="text-slate-500 mb-12 text-xl relative z-10 max-w-2xl mx-auto">
                    Biến ý tưởng thành hình ảnh chuyên nghiệp ngay hôm nay mà không cần kỹ năng vẽ.
                </p>
