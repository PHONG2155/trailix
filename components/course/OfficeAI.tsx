...
import { 
  ArrowRight, 
  FileText,     // Icon cho Soạn thảo
  BarChart3,    // Icon cho Phân tích dữ liệu
  Presentation, // Icon cho Slide/Thuyết trình
  Search,       // Icon cho Nghiên cứu
  Zap,
  Target,
  Flame,
  MousePointerClick
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col justify-center items-center relative px-4">
           ...
           >
            ...
            <span className="text-sm font-bold text-red-700 tracking-wide uppercase">AI for Productivity</span>
          </motion.div>
          ...
          <div className="max-w-screen-2xl mx-auto text-center space-y-6 px-4">
            <motion.h1 
              ...
              viewport={{ once: true }}
              // ĐÃ SỬA: Size nhỏ (4xl-7xl), tracking-widest, leading-normal
            ...
            >
              ỨNG DỤNG AI CƠ BẢN
              {/* ĐÃ SỬA: Tách dòng đỏ block mt-2 */}
            ...
            >
              Từ <span className="text-slate-900 font-bold">Soạn Thảo</span> Đến <span className="text-slate-900 font-bold">Phân Tích Dữ Liệu</span> – Bộ Kỹ Năng Thiết Yếu.
            </motion.p>
        ...
        <section className="py-24 bg-white relative">
            ...
            <h3 className="text-3xl md:text-4xl font-black leading-tight text-slate-900">
              “Đừng làm việc chăm chỉ hơn, <br />
              <span className="text-red-600">
                 hãy làm việc thông minh hơn cùng AI.
              </span>”
            </h3>
          </motion.div>
        </section>
            ...
            >
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group overflow-hidden relative">
                <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:opacity-10 transition-opacity">
                    <FileText className="w-40 h-40 text-red-600" />
                </div>
                <div className="relative z-10">
                    <div className="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mb-6">
                      <FileText className="w-7 h-7" />
                    </div>
                    <h4 className="text-2xl font-bold mb-3 text-slate-900">Soạn thảo siêu tốc</h4>
                    <p className="text-slate-600 text-lg leading-relaxed max-w-md">
                      Tối ưu hóa việc soạn thảo văn bản, email, báo cáo và sáng tạo nội dung chuyên nghiệp chỉ trong tích tắc.
                    </p>
                </div>
              </motion.div>

              {/* Value 2: Phân tích dữ liệu (Red Card) */}
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-red-700 text-white p-10 rounded-3xl shadow-xl shadow-red-900/10 flex flex-col justify-between group">
                <div>
                    ...
                    <h4 className="text-2xl font-bold mb-3">Phân tích dữ liệu</h4>
                    <p className="text-red-50 text-lg">
                      Kỹ năng làm sạch dữ liệu thô, thống kê và trích xuất thông tin (insights) quan trọng hỗ trợ ra quyết định.
                    </p>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all group">
                ...
                <h4 className="text-xl font-bold mb-3 text-slate-900">Thiết kế Slide thần tốc</h4>
                <p className="text-slate-600 text-lg">
                  Tạo slide thuyết trình đẹp mắt, bố cục chuẩn chỉnh với Gamma, Claude Designer hoặc Gemini.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} whileHover={{ y: -5 }} className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:border-red-200 transition-all flex items-center gap-8">
                 ...
                 <div>
                    <h4 className="text-xl font-bold mb-2 text-slate-900">Tư duy "AI-First"</h4>
                    <p className="text-slate-600 text-lg">
                      Tiết kiệm 2-3 giờ làm việc mỗi ngày nhờ luôn nghĩ đến giải pháp AI trước khi bắt tay vào làm thủ công.
                    </p>
                 </div>
              </motion.div>
            </motion.div>
        ...
        <section className="py-24 px-4 bg-white relative">
          <div className="max-w-5xl mx-auto">
             ...
             >
                 ...
                 <p className="text-slate-500 text-lg">Bộ kỹ năng "sinh tồn" trong kỷ nguyên số.</p>
             </motion.div>
             ...
             >
                {[
                    { step: "01", title: "Ôn tập kỹ thuật Prompt", content: "Nắm vững cách viết lệnh rõ ràng, mạch lạc để AI hiểu đúng ý." },
                    { step: "02", title: "Soạn thảo văn bản", content: "Viết email, công văn, proposal, nội dung mạng xã hội chuyên nghiệp." },
                    { step: "03", title: "Kỹ năng sáng tạo", content: "Phát triển ý tưởng đột phá và kể chuyện (storytelling) thu hút." },
                    { step: "04", title: "Nghiên cứu thị trường", content: "Sử dụng 'Deep Research' để phân tích đối thủ & thấu hiểu khách hàng." },
                    { step: "05", title: "Phân tích dữ liệu", content: "Làm sạch dữ liệu thô, thống kê nhanh và tìm ra insights đắt giá." },
                    { step: "06", title: "Thiết kế báo cáo", content: "Sử dụng Gamma, Claude, Gemini để tạo slide báo cáo tự động trong 30 phút." },
                    { step: "07", title: "Tối ưu PowerPoint", content: "Tinh chỉnh bố cục, màu sắc và trực quan hóa dữ liệu ấn tượng." }
                ].map((item, index) => (
                    <motion.div 
                      key={index} 
                      variants={fadeInUp}
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
             ...
             >
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {["Nhân viên văn phòng", "Quản lý", "HR/Admin", "Sales/Marketing", "Bất kỳ ai muốn tăng năng suất"].map((tag, i) => (
                    <motion.span 
                      key={i} 
             ...
             >
                ...
                <p className="text-slate-500 mb-12 text-xl relative z-10 max-w-2xl mx-auto">
                    Đừng bỏ lỡ cơ hội trang bị bộ kỹ năng "sinh tồn" trong kỷ nguyên số.
                </p>
